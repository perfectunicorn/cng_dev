...
class AuthorHydrator implements HydratorInterface
{
    ...
    {
        if (!$object instanceof Career || !$object instanceof Education || !$object instanceof Project ||  !$object instanceof Post || !$object instanceof Comment || $object->getAuthor() == null) {
            return array();
        }
